...
export function ProfileUserLayout({
  ...
  switch (breadcrumb) {
    case "account-user":
      showLabelBreadcrumb = "Tài khoản của tôi";
      break;
    case "order":
      showLabelBreadcrumb = "Đơn hàng";
      break;
    case "notification":
      showLabelBreadcrumb = "Thông báo";
      break;
    case "reward-point":
      showLabelBreadcrumb = "Điểm thưởng";
      break;
    case "order-details":
      showLabelBreadcrumb = "Chi tiết đơn hàng";
      break;
  }
