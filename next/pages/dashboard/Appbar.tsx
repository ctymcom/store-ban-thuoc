            ...
            <div className="header-bar top-0 left-0 fixed w-full h-14 min-h-48 max-h-14 bg-white z-50 shadow flex items-center font-sans">
                ...
                <div className="relative h-full flex items-center w-72 h-50 line-white " onMouseOver={() => setopenProfile(true)} onMouseLeave={() => setopenProfile(false)}>
                    ...
                    <div onMouseOver={() => setopenProfile(true)} onMouseLeave={() => setopenProfile(false)}
                        className={`${openProfile ? 'block' : 'hidden'} z-50 absolute bg-white left-8 top-14 shadow-md rounded-sm max-w-6xl origin-center origin-top  with-arrow `}>
                ...
                <div className="action-header px-7 flex  space-x-3 max-w-5xl ">
                    <div className="h-full relative duration-300 " onMouseOver={() => setopenNotic(true)} onMouseLeave={() => setopenNotic(false)}>
                        ...
                        <div onMouseOver={() => setopenNotic(true)} onMouseLeave={() => setopenNotic(false)}
                            className={`${openNotic ? 'block' : 'hidden'} hover:block w-80 text-center max-w-5xl z-50 absolute bg-white -left-32 top-12 shadow-md rounded-sm  origin-center origin-top  with-arrow `}>
