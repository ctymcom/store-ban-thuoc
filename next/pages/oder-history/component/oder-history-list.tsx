import { OderHistoryData } from './oder-history-data';

export function OderHisttoryList() {
    return <>
    {
        OderHistoryData.map((item, index) => {
            return  <div className="oder-history__info-item flex justify-between items-center border-b-2 py-3" key={index}>
                        ...
                        <button className="oder-history__btn-repurchase bg-btn-success text-white px-16 h-10 whitespace-nowrap">Mua lại</button>
                    </div>
        })
    }    
    </>;
