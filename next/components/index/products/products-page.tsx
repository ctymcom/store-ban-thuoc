    ...
    return <>
        {
            ...
            <>
            {
                ...
                >
                    ...
                    <div className="absolute bg-black w-full h-full opacity-40" onClick={() => setFilterOpened(false)}></div>
                    <div className="relative w-8/12 max-w-xs h-full bg-white shadow-md min-w-2xs flex flex-col">
                        ...
                        <div className="flex flex-col w-full p-4 v-scrollbar" style={{ maxHeight: 'calc(100vh - 4rem)' }}>
                ...
                <div className="py-4 md:py-12 main-container flex">
                    ...
                    <div className="flex-grow pl-3">
                            ...
                            !screenLg && <>
                                <div className="flex justify-between">
                                    <button className="btn-default px-0" onClick={() => setFilterOpened(true)}>
                                        <i className="text-xl"><HiFilter/></i>
                                        <span>Lọc</span>
                                    </button>
                                    <ProductsFilterSort/>
                                </div>
                        ...
                        {
                            screenLg && <div className="flex justify-between">
