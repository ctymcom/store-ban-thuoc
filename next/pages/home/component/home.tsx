...
export function Home() {
  return (
    <>
      ...
      <div className="container-1 py-8 grid md:grid-cols-4 grid-cols-1  divide-x-0 md:divide-x-2">
        <div className="p-4 flex items-center flex-col">
          <div className="w-16">
            <IconShip />
          </div>
          <div className="uppercase py-4 text-green-400 text-center">Miễn phí giao vận</div>
        ...
        <div className="p-4 flex items-center flex-col">
          ...
          <div className="uppercase py-4 text-green-400 text-center">TẬN TÂM PHỤC VỤ</div>
          <div className="descrip">
            <p className="text-center">
        ...
        <div className="p-4 flex items-center flex-col">
          ...
          <div className="uppercase py-4 text-green-400 text-center">CỬA HÀNG GẦN BẠN</div>
          <div className="descrip">
            <p className="text-center">
        ...
        <div className="p-4 flex items-center flex-col">
          ...
          <div className="uppercase py-4 text-green-400 text-center">MUA HÀNG TRỰC TUYẾN</div>
          <div className="descrip">
            <p className="text-center">
