...
export function ProductInfo(props) {
  ...
  return (
    <>
      ...
      <a href="#" className="product__name mb-2 block text-2xl">
        {props.product.name}
      </a>
      <div className="tag-type my-5">
        ...
        <span className="border border-primary px-4 py-1 rounded-full text-white bg-primary">
          Điểm tích lũy: 10đ
        </span>
      </div>
      <div className="product__price mb-6">
        <span className="product__price-current text-primary mr-4 text-2xl">
          {NumberPipe(props.product.sale_price)} VNĐ/hộp
        </span>
        <span className="product__price-old text-gray-400 line-through text-base">
          {NumberPipe(props.product.old_price)}
        </span>
      </div>
      ...
      <div className="number flex items-center mt-0 mb-8">
        ...
        <div className="button-group flex relative items-center w-32 h-10">
          <button
            className="btn-default p-0 w-8 h-10 text-64 text-primary hover:text-primary-dark"
          ...
          <input
            className="w-11 h-12 text-center text-lg mx-5"
      ...
      <div className="btn-group flex">
        <div className="btn-add-to-cart">
          <button className="bg-warning rounded-md text-white px-4 py-2.5 focus:outline-none">
            Thêm vào giỏ
          </button>
        </div>
        <div className="btn-add-to-cart">
          <Link href="/cart">
            <button className="bg-primary rounded-md text-white px-4 py-2.5 focus:outline-none ml-8">
              Mua ngay
            </button>
          </Link>
        </div>
      ...
      <div className="tag-name mt-5">
        ...
        <span className="text-sm text-primary ml-2">
          Sản phẩm mới, Sản phẩm giảm giá, Sản phẩm độc quyền
        </span>
      </div>
    </>
  );
