      ...
      <div className="flex flex-col md:flex-row mt-4">
        <div className="relative mt-2 md:mt-0 w-full md:w-2/5 z-20">
          {product?.tags.includes("NEW") && (
            <div className="flex-center z-50 absolute -left-2 xs:-left-3 sm:-left-3.5 md:-left-2 lg:-left-2.5 -top-2 xs:-top-3 sm:-top-3.5 md:-top-2 lg:-top-3 text-white font-semibold">
              <img
          ...
          {product?.tags.includes("FLASHSALES") && (
            <div className="flex-center z-50 absolute -right-0.5 sm:-right-1 md:-right-0.5  lg:-right-1 -top-2 xs:-top-2.5 sm:-top-3 md:-top-1.5 lg:-top-2.5 text-white font-semibold">
              <img
                className="w-16 xs:w-20 sm:w-24 md:w-14 lg:w-20 h-16 xs:h-20 sm:h-24 md:h-14 lg:h-20"
