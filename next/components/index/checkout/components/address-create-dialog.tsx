    ...
    <Dialog width="420px" isOpen={props.isOpen} mobileMode={false}
                ...
                <Dialog.Body>
                  <div className="flex flex-wrap gap-4 py-4 text-16 sm:text-20">
                    <input className="form-input w-full h-12 text-16 sm:text-20" placeholder="Họ và tên"/>
                    <input className="form-input w-full h-12 text-16 sm:text-20" placeholder="Số điện thoại"/>
                    ...
                    <input className="form-input w-full h-12 text-16 sm:text-20" placeholder="Nhập địa chỉ, tên đường, tòa nhà..."/>
                    <div className="w-full h-12 flex items-center gap-2 cursor-pointer" onClick={()=>{setDefaultAdrress(!defaultAdrress)}}>
                      <CheckBoxSquare checked={defaultAdrress}/> Chọn làm địa chỉ mặc định
                      </div>
                    <button className="btn-primary w-full h-12 text-16 sm:text-20" onClick={()=>{}}>Xác nhận</button>
                  </div>
                </Dialog.Body>
            </Dialog>
  );
