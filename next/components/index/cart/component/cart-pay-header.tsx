...
export function CartPayHeader() {
    ...
    return <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl w-5/6 sm:w-4/5 md:w-3/5 lg:w-2/5 mx-auto my-10 text-center uppercase text-gray-300 flex items-center">
