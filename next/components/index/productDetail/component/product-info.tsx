...
export function ProductInfo(props) {
    ...
    return  <>
            ...
            <div className="product__price mb-6">
                <span className="product__price-current text-green-500 mr-4 text-2xl">{props.product.sale_price}/hộp</span>
            ...
            <p className="product__name w-32 h-10 flex justify-between items-center border px-2 border-success mb-6 rounded-sm">
                <button className="minus text-xl focus:outline-none hover:text-success"
                        onClick={() => (NumberProduct <= 0) ? NumberProduct == 0 : setNumberProduct(NumberProduct - 1)}>-</button>
                    { NumberProduct }
                <button className="plus text-xl focus:outline-none hover:text-success"
