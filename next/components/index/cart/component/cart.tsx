...
export function CartPayPromotion(props) {
    ...
    const handleSetPromotion = () => {
        let promotionCode = (document.getElementById("Input__Promotion") as HTMLInputElement).value;
        if (promotionCode === "ABC") {
            let listNewMoneyCart = listMoneyCart;
            let disCount = listNewMoneyCart[0].money * 50 / 100;
            listNewMoneyCart[1].money = disCount;
            listNewMoneyCart[2].money = listNewMoneyCart[0].money - disCount;
            setListMoneyCart(listNewMoneyCart);
        }
    }
        ...
        <div id="have__Item">
            <div className="grid grid-cols-7 gap-20 text-lg">
                ...
                <div id="cart" className="col-span-2">
                    <div id="cart__Promotion">
                        ...
                        <input id="Input__Promotion" className="block w-full border-2 border-gray-300 rounded my-3 px-2 py-1" type="text" placeholder="Nhập mã ưu đãi" />
                        <button onClick={handleSetPromotion} type="button" className="border-2 border-gray-300 rounded bg-gray-200 w-full text-gray-400 py-1 px-2 text-center">Áp dụng</button>
                    </div>
                    <div id="cart__TotalMoney" className="mt-10">
                        <CartTotalMoney listMoney={ListMoneyCart} />
                        <button className="border border-gray-300 rounded w-full p-2 mt-2 bg-primary-500 text-center text-white"
            ...
            <div className="text-primary-500 flex items-center">
                ...
                <div className={Change ? "inline" : "hidden"}>
                    <button className="border border-gray-300 rounded p-2 m-2 bg-primary-500 text-white text-center"
