export function PaginationNextBtnCusTom({ onClick }) {
    return <li>
      <button
        className="flex ml-1.5 items-center justify-center px-2.5 py-2.5 rounded-full border-2 focus:outline-none focus:shadow-outline-purple border-gray-600 hover:bg-btn-success hover:text-white hover:border-success"
        aria-label="Next"
        onClick={onClick}
      >
