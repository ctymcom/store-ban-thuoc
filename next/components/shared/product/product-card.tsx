        ...
        <div className="flex flex-col min-w-4xs place-content-between">
          <Link href={"/product/" + product.code}>
            <a className="group">
              ...
              <div className="text-lg text-gray-800 pt-1 pb-1 font-semibold leading-snug text-ellipsis-3 group-hover:text-primary-dark" title={product.name}>{product.name}</div>
            </a>
          </Link>
