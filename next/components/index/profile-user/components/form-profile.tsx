...
export function FormProfile() {
    ...
    {
        user ? <>
            <div className="w-11/12 lg:w-5/6 mx-auto xl:ml-40 text-16 sm:text-20 text-gray-700 mt-5 sm:mt-10">
                ...
                <div className="flex flex-wrap-reverse w-full">
                    <div className="w-full xl:w-3/5 items-center">
                        <div className="pr-0 xl:pr-16 xl:border-r border-gray-400">
                            <div className="sm:flex justify-between items-center">
                                ...
                                <input className="form-input w-full sm:w-3/4 text-16 sm:text-20" value={user.username} onChange={(e) => { handleChange("name", e.target.value) }} />
                            </div>
                            <div className="sm:flex justify-between items-center pt-4">
                                <p className="w-full sm:w-1/4">Số điện thoại</p>
                                <input className="form-input w-full sm:w-3/4 text-16 sm:text-20" value={user.phone} onChange={(e) => { handleChange("phoneNumber", e.target.value) }} />
                            </div>
                            <div className="sm:flex justify-between items-center pt-4">
                                <p className="w-full sm:w-1/4">Email</p>
                                <input className="form-input w-full sm:w-3/4 text-16 sm:text-20" value={user.email} onChange={(e) => { handleChange("email", e.target.value) }} />
                            </div>
                            <div className="sm:flex justify-between items-center pt-4 sm:h-12">
                                ...
                                <div className="w-full sm:w-3/4 h-12 flex gap-4">
                                    <Gender gender={user.userRef} handleChange={handleChange} />
                                </div>
                            ...
                            <div className="sm:flex justify-between items-center pt-4">
                                ...
                                <div className="w-full sm:w-3/4 flex space-x-2">
                                    <DateTime dateOfBirth={user.birthday == null ? new Date() : user.birthday} handleChange={handleChange} />
                                </div>
                            </div>
                            <div className="sm:flex justify-between items-center pt-4">
                    ...
                    <div className="flex xl:inline-block w-full xl:w-2/5 justify-around items-center">
                        ...
                        <div className="w-2/3 mx-auto flex items-center flex-wrap">
                            <button className="sm:mx-auto w-2/3 sm:h-12 my-2 btn-outline text-16 sm:text-20 border-primary border font-normal text-primary hover:bg-primary hover:text-white">Đổi ảnh</button>
