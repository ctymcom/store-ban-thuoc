  ...
  return (
    <>
      <footer className=" mt-20 text-white transition">
        <div className=" w-full py-8 bg-gray-700  flex flex-col space-y-4 md:grid md:grid-cols-3 container-1">
          <div className="flex flex-col justify-start text-sm md:w-3/6 ">
          ...
          <div className="flex flex-col justify-start text-sm md:w-3/6 ">
            ...
            <div className="md:w-6/6 px-4 py-3 mt-5 bg-green-500  text-center rounded-full cursor-pointer ">
          ...
          <div className="flex flex-col justify-start text-sm">
            <div className="">
              ...
              <div className="py-4 flex ">
                <input
                  type="text"
                  className="w-8/12 md:w-6/12 px-4 py-3 focus:outline-none rounded-l-full"
