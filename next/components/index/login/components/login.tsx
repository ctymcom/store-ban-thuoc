  ...
  return (
    <form className="flex flex-col items-center animate-emerge" onSubmit={onFormSubmit}>
      ...
      <input 
        ...
        placeholder="Tên đăng nhập hoặc Email" ref={ref}
        value={username}
      ...
      <div className="w-full flex flex-col items-center mt-4">
        <button type="submit" className="btn-primary btn-lg w-full">Đăng nhập</button>
        <div className="flex justify-between mt-2 w-full">
          <button type="button" className="btn-default hover:underline" onClick={() => props.setMode('register')}>Đăng ký</button>
          <button type="button" className="btn-default hover:underline">Quên mật khẩu</button>
        </div>
      </div>
    </form>
  )
