export function PaginationFirstPageBtnCustom({ onClick }) {
    return <li>
        <button
            className="flex mr-3 items-center justify-center px-2.5 py-2.5 rounded-full border-2 focus:outline-none focus:shadow-outline-purple border-gray-600 hover:text-primary hover:border-primary"
            aria-label="Previous"
            onClick={onClick}
        >
